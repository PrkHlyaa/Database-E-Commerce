...
CREATE TABLE detailproduk (
    ...
    diskon_nama_diskon VARCHAR2(64 CHAR)
);
...
CREATE TABLE keranjang (
    ...
    id_detail_produk VARCHAR2(16 CHAR),
    id_checkout      VARCHAR2(16 CHAR) NOT NULL,
...
CREATE TABLE kota (
    ...
    id_provinsi VARCHAR2(32) NOT NULL
);
...
ALTER TABLE alamatcustomer
    ADD CONSTRAINT alamatcustomer_customer_fk FOREIGN KEY ( id_customer )
...
ALTER TABLE detailproduk
    ADD CONSTRAINT detailproduk_diskon_fk FOREIGN KEY ( diskon_nama_diskon,
                                                        id_diskon )
